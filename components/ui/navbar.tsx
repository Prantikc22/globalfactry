...
export function Navbar() {
  ...
  const capabilities = [
    ...
    {
      href: "/capabilities/die-casting",
      label: "Die Casting",
      description: "High-pressure casting with tight tolerances",
    },
    ...
    {
      href: "/capabilities/sheet-metal-stamping",
      label: "Sheet Metal Stamping",
      description: "Progressive and transfer stamping",
    },
    {
      href: "/capabilities/prototyping-pre-production",
      label: "Prototyping",
    ...
    },
    {
      ...
      description: "Precision casting for complex geometries",
    },
    {
      href: "/capabilities/assembly-services",
      label: "Assembly Services",
      description: "Complete assembly with quality assurance",
    },
  ]
